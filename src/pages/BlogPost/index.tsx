...
import img1 from '../../assets/BlogPost/img1.png'
import img2 from '../../assets/BlogPost/img2.png'
import img3 from '../../assets/BlogPost/img3.png'
{/*

		//!
		//! цей код  при нажиманні на карточку BLOG
		//!
